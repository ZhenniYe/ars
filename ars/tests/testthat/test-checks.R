...
test_that("Check Log-concave", {
  ...
  expect_true(Check_logconcave(dunif, c(0, 0.5, 1)))
  expect_true(Check_logconcave(dexp, c(1:10)))
  ...
  expect_false(Check_logconcave(chi_test2, c(100:1000)))
...
test_check("Check Differentiability",{
  # differentiable
...
test_check("Check for Existance", {
